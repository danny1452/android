...
class MainActivity : AppCompatActivity() {
    ...
    private fun setOneTimeWorkRequest() {
        ...
        // create data to be put in request - to be accessed in worker
        val data: Data = Data.Builder()
            .putInt(KEY_COUNT_VALUE,125)
            .build()
        // create constraints to be put in request
        val constraints = Constraints.Builder()
            .setRequiresCharging(true)
            .setRequiredNetworkType(NetworkType.CONNECTED)
            .build()

        // create request put in queue with help of work manager
        ...
        val downloadingWorker= OneTimeWorkRequest.Builder(DownloadingWorker::class.java)
            .build()
        // create list of request to be executed in parallel
    ...
    private fun setPeriodicWorkRequest(){
       ...
       val periodicWorkRequest = PeriodicWorkRequest
               // worker , interval, interval unit
           .Builder(DownloadingWorker::class.java,16,TimeUnit.MINUTES)
           .build()
        // get work manager for application ontext
