...
// composable for recycler view item
// used in recyclerview lazy column items
// argument lambda function for on click listener
@Composable
    ...
    Card(
        ...
        Row(
            modifier = Modifier
                .padding(5.dp)
                .fillMaxWidth()
                .clickable { selectedItem(tvShow) },// listener for row
            verticalAlignment = Alignment.CenterVertically
        ) {
            // to display image
            TvShowImage(tvShow = tvShow)
            // to display part of tv shows
            Column {
