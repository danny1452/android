...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // this set Content is omposable block
        setContent {
            // get view model - this type is allowed with composable else view model provider needs to be usd

            val viewModel = viewModel<MyViewModel>()
            // in compose collect as State used
